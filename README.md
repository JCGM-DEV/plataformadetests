...
![Dashboard Preview](https://img.shields.io/badge/Status-V6_Professional-blue?style=for-the-badge&logo=github)
![Data Pool](https://img.shields.io/badge/Bank-3.500_Questions-cyan?style=for-the-badge)
![Target](https://img.shields.io/badge/Exam-May_2026-gold?style=for-the-badge)
...
*   **Banco Masivo de Datos**: Pool de 3.500 preguntas técnicas reales (500 por asignatura) cubriendo el 100% del temario:
    ...
    *   Lenguajes de Marcas (HTML5, CSS3, XML, XPath/XSD).
    *   Entornos de Desarrollo (Git, Scrum, Testing, UML).
    *   Cloud Computing (AWS, IaaS/PaaS, Seguridad Cloud).
    *   Empleabilidad (Estatuto de los Trabajadores, Nóminas).
*   **Evaluación Real de FP**: Sistema de calificación basado en el estándar `Nota = (Aciertos - Errores * 0.5) / N * 10`.
*   **Feedback Inmediato**: Explicaciones pedagógicas detalladas cada vez que se falla una pregunta.
*   **Diseño Premium**: Interfaz moderna en modo oscuro con efectos Glassmorphism para evitar la fatiga visual durante el estudio.
