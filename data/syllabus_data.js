const SYLLABUS_RAW_DATA = {
  "bd_tema_1": [
    {
      "concept_id": "bd_tema_1_q0",
      "question": "¿Cuál de los siguientes formatos de archivo representa la información en una estructura tabular fija de filas y columnas?",
      "options": [
        "JSON",
        "XML",
        "CSV",
        "Fichero de texto plano sin formato"
      ],
      "correct": 2,
    ...
    },
    {
      ...
      "question": "En el modelo Entidad-Relación, el conjunto de objetos del mundo real que comparten los mismos atributos y se identifican con un nombre común se denomina?",
      "options": [
        "Relación",
        "Atributo",
        "Tupla",
    ...
    },
    {
      ...
      "question": "Según la clasificación de bases de datos basada en su modelo lógico, ¿cuál de las siguientes opciones NO pertenece a dicha clasificación?",
      "options": [
        "Jerárquicas",
        "Relacionales",
    ...
    },
    {
      ...
      "question": "¿Qué tipos de fichero permiten incorporar medidas de seguridad como contraseñas y encriptación?",
      "options": [
        "Planos",
        "Secuenciales",
        "Multimedia",
    ...
    },
    {
      ...
      "question": "¿Entre qué tipos de bases de datos se encuentran las que permiten almacenar datos semiestructurados?",
      "options": [
        "Relacionales",
        "Jerárquicas",
        "Distribuidas",
    ...
    },
    {
      ...
      "question": "¿Qué tipo de bases de datos permiten incluir herencia en su diseño?",
      "options": [
        "Jerárquicas",
        "Relacionales",
        "Distribuidas",
    ...
    },
    {
      ...
      "question": "¿Qué lenguaje usa la inmensa mayoría de bases de datos relacionales?",
      "options": [
        "C++",
        "Java",
        "Python",
    ...
    },
    {
      ...
      "question": "¿Qué tipos de bases de datos permiten reducir los cuellos de botella y aumentar la disponibilidad de los datos?",
      "options": [
        "Centralizadas",
        "Jerárquicas",
        "Relacionales",
    ...
    },
    {
      ...
      "question": "¿Quién acuñó la palabra \"informatique\" en 1962, de la que deriva el término informática?",
      "options": [
        "Philippe Doumar",
        "Philippe Chason",
        "Charles Babbage",
    ...
    },
    {
      ...
      "question": "¿De qué tipo es un fichero dBASE?",
      "options": [
        "Plano",
        "Multimedia",
        "Secuencial",
  ...
  "bd_tema_2": [
    {
      ...
      "question": "¿Cómo se denomina una clave primaria que incluye más de una columna de una tabla?",
      "options": [
        "Heterogénea",
        "Simple",
        "Foránea",
    ...
    },
    {
      ...
      "question": "¿Qué comando DML permite cancelar los cambios realizados durante una transacción?",
      "options": [
        "COMMIT TRANSACTION",
    ...
    },
    {
      ...
      "question": "¿Con qué tipo de dato encaja el valor representativo de verdadero o falso?",
      "options": [
        "Fecha y hora",
    ...
    },
    {
      ...
      "question": "¿Mediante qué elementos se establecen las relaciones entre tablas en el modelo relacional?",
      "options": [
        "Índices de tipo Árbol B",
        "Índices Hash",
    ...
    },
    {
      ...
      "question": "¿Cómo se denominan los grupos de usuarios que comparten privilegios y responsabilidades en una base de datos?",
      "options": [
        "Privilegiados",
        "Grupos",
        "Perfiles",
    ...
    },
    {
      ...
      "question": "¿Con qué concepto del modelo E-R encaja la matrícula de un vehículo?",
      "options": [
        "Relación",
        "Tupla",
        "Entidad",
    ...
    },
    {
      ...
      "question": "¿Qué comando DDL sirve para eliminar una tabla completamente?",
      "options": [
        "ALTER TABLE",
        "DELETE TABLE",
        "TRUNCATE TABLE",
  ...
  "bd_tema_3": [
    {
      ...
      "question": "¿Qué símbolo se utiliza para representar las entidades en un diagrama ER?",
      "options": [
        "Rectángulos",
        "Elipses",
        "Rombos",
    ...
    },
    {
      ...
      "question": "¿Cuál es la definición de un atributo derivado?",
      "options": [
  ...
  "bd_tema_4": [
    {
      ...
      "question": "¿Cuál es la cláusula necesaria para especificar la tabla de la que se extraen los datos?",
      "options": [
        "SELECT",
        "FROM",
        "WHERE",
    ...
    },
    {
      ...
      "question": "¿Qué operador se utiliza en la cláusula WHERE para filtrar por un rango de valores?",
      "options": [
        "LIKE",
        "IN",
        "BETWEEN",
    ...
    },
    {
      ...
      "question": "¿Cuál es la función de agregado que devuelve el valor máximo de una columna?",
      "options": [
        "SUM()",
        "MAX()",
        "AVG()",
    ...
    },
    {
      ...
      "question": "¿Qué tipo de JOIN devuelve todos los registros de la tabla de la izquierda, aunque no tengan correspondencia en la derecha?",
      "options": [
        "INNER JOIN",
        "LEFT JOIN",
        "RIGHT JOIN",
    ...
    },
    {
      ...
      "question": "¿Qué palabra clave se usa para comprobar si un valor existe dentro de una lista devuelta por una subconsulta?",
      "options": [
        "LIKE (para búsqueda de patrones con comodines)",
        "EXISTS (comprueba si la subconsulta devuelve alguna fila)",
        "BETWEEN (para rangos de valores numéricos o de fecha)",
        "IN (comprueba si el valor está en la lista devuelta por la subconsulta)"
      ],
      "correct": 3,
    ...
    },
    {
      ...
      "question": "¿Qué operación de conjuntos combina los resultados de dos consultas eliminando los duplicados automáticamente?",
      "options": [
        "UNION",
        "INTERSECT",
        "EXCEPT (o MINUS)",
  ...
  "bd_tema_5": [
    {
      ...
      "question": "¿Cuál es la sentencia SQL estándar para insertar nuevos registros en una tabla?",
      "options": [
        "ADD RECORD",
        "INSERT INTO",
        "UPDATE",
    ...
    },
    {
      ...
      "correct": 0,
      "explanation": "Porque si se omite, se actualizarán todos los registros de la tabla. es la respuesta correcta para esta pregunta del temario oficial.",
      "unit": null
    },
    {
      "concept_id": "bd_tema_5_q3",
      "question": "¿Qué opción de integridad referencial borra automáticamente las filas hijas cuando se borra la fila padre?",
      "options": [
        "ON DELETE SET NULL",
        "ON DELETE CASCADE",
        "ON DELETE RESTRICT",
    ...
    },
    {
      ...
      "question": "¿Qué sentencia se utiliza para confirmar y guardar permanentemente todos los cambios de una transacción?",
      "options": [
        "START TRANSACTION",
        "ROLLBACK",
        "COMMIT",
    ...
    },
    {
      ...
      "question": "¿Qué sintaxis se utiliza en MySQL para bloquear filas seleccionadas para una posterior actualización dentro de una transacción?",
      "options": [
        "SELECT * FROM tabla WHERE id=1 FOR UPDATE;",
        "LOCK TABLES tabla WRITE;",
        "UPDATE tabla SET locked = true;",
        "Mediante una subconsulta correlacionada con EXISTS"
      ],
      "correct": 0,
  ...
  "bd_tema_6": [
    {
      ...
      "question": "¿Cuál es la sintaxis correcta para definir una variable de usuario en MySQL que almacene información temporal en una sesión?",
      "options": [
        "VAR mi_variable = 10;",
        "SET @mi_variable = 10;",
    ...
    },
    {
      ...
      "question": "¿Qué palabra clave se utiliza al crear una función para indicar que siempre devuelve el mismo resultado para los mismos parámetros de entrada?",
      "options": [
        "STABLE",
        "VOLATILE",
        "DETERMINISTIC",
    ...
    },
    {
      ...
      "question": "¿Qué estructura de iteración se evalúa al final del ciclo, garantizando que el conjunto de instrucciones se ejecute al menos una vez?",
      "options": [
        "WHILE",
        "REPEAT",
        "LOOP",
    ...
    },
    {
      ...
      "question": "Para ejecutar un procedimiento almacenado en MySQL, ¿qué instrucción debe utilizarse?",
      "options": [
        "EXECUTE",
        "RUN",
        "CALL",
    ...
    },
    {
      ...
      "question": "¿Qué variable del sistema debe estar en ON para que los eventos programados con CREATE EVENT llegar a ejecutarse?",
      "options": [
        "event_scheduler",
    ...
    },
    {
      ...
      "question": "¿Qué tipo de dato compuesto se utiliza para almacenar uno o varios valores de un conjunto de opciones predefinidas, guardándose internamente como un mapa de bits?",
      "options": [
        "ENUM",
        "SET",
        "ARRAY",
    ...
    },
    {
      ...
      "question": "En el tratamiento de excepciones, ¿qué manejador aborta la ejecución del código inmediatamente cuando se produce un error crítico?",
      "options": [
        "CONTINUE HANDLER",
        "EXIT HANDLER",
        "STOP HANDLER",
    ...
    },
    {
      ...
      "question": "¿Qué objeto de base de datos se utiliza para recorrer los resultados de una consulta SQL de manera secuencial y fila por fila?",
      "options": [
        "Trigger",
        "Index",
        "Cursor",
  ...
  "bd_tema_7": [
    {
      ...
      "question": "¿Qué característica de un ORDBMS permite definir una tabla \"hija\" que incluya automáticamente las columnas y restricciones de una tabla \"padre\"?",
      "options": [
        "Polimorfismo",
        "Herencia de tablas",
        "Encapsulamiento de tipos",
        "Mediante una subconsulta correlacionada con EXISTS"
      ],
      "correct": 1,
    ...
    },
    {
      ...
      "question": "Durante la instalación de PostgreSQL, ¿cuál es el puerto de conexión que se asigna por defecto?",
      "options": [
        "3306",
        "8080",
        "5432",
    ...
    },
    {
      ...
      "question": "¿Qué cláusula se utiliza en la sentencia CREATE TABLE de PostgreSQL para heredar de otra tabla?",
      "options": [
        "EXTENDS",
        "INHERITS",
        "FROM",
    ...
    },
    {
      ...
      "question": "¿Cuál de los siguientes es un tipo de dato nativo geométrico en PostgreSQL?",
      "options": [
        "CIRCLE",
        "SPHERE",
        "TRIANGLE",
    ...
    },
    {
      ...
      "question": "Al ejecutar un SELECT * FROM tabla_padre en PostgreSQL, ¿qué registros se obtienen por defecto?",
      "options": [
    ...
    },
    {
      ...
      "question": "¿Qué tipo de dato de colección representa un intervalo de valores continuos (como un rango de fechas)?",
      "options": [
        "ARRAY",
        "JSONB",
        "RANGE",
    ...
    },
    {
      ...
      "question": "¿Cómo se llama el lenguaje procedimental propio de PostgreSQL utilizado para crear funciones avanzadas?",
      "options": [
        "PL/SQL",
        "PL/pgSQL",
        "T-SQL",
    ...
    },
    {
      ...
      "question": "¿Qué sentencia estándar de SQL se utiliza en PostgreSQL para definir un tipo de dato personalizado (como un tipo compuesto)?",
      "options": [
        "CREATE TYPE",
        "CREATE OBJECT",
        "DEFINE DATA",
  ...
  "lm_tema_2": [
    ...
    },
    {
      ...
      "question": "Dentro de los atributos HTML, ¿cuál de los siguientes es considerado un atributo específico de ciertos elementos (como img o a), y no un atributo global que se pueda usar en la mayoría de las etiquetas?",
      "options": [
        "class",
        "id",
        "src",
    ...
    },
    {
      ...
      "question": "En HTML5, ¿qué etiqueta semántica se utiliza para representar una sección de una página que contiene información relacionada con el contenido principal, pero que no es tan relevante, como una barra lateral?",
      "options": [
        "header",
        "section",
        "aside",
    ...
    },
    {
      ...
      "question": "Dado el fragmento HTML: p > a > span, ¿qué selector CSS NO aplicaría estilos directamente al elemento span?",
      "options": [
        "p span",
        "a span",
        "p > span",
    ...
    },
    {
      ...
      "question": "Para una tabla HTML, ¿qué conjunto de etiquetas agrupa semánticamente las filas del encabezado, el cuerpo y el pie?",
      "options": [
        "table, tr, td",
        "caption, thead, tfoot",
        "thead, tbody, tfoot",
    ...
    },
    {
      ...
      "question": "¿Cuál de las siguientes etiquetas HTML es explícitamente obsoleta (deprecated) en HTML5, recomendándose que su funcionalidad sea manejada por CSS?",
      "options": [
        "p",
        "h1",
        "font",
    ...
    },
    {
      ...
      "question": "Al utilizar la etiqueta form con el atributo method=\"post\", ¿qué atributo indica el tipo de contenido utilizado para enviar los datos, siendo esencial para la subida de archivos?",
      "options": [
        "action",
        "target",
        "enctype",
  ...
  "lm_tema_3": [
    {
      ...
      "question": "Según las reglas de las etiquetas XML para la buena formación de un documento, ¿cuál de las siguientes afirmaciones es correcta?",
      "options": [
    ...
    },
    {
      ...
      "question": "¿Qué característica debe cumplir un documento XML para ser considerado válido, además de estar bien formado?",
      "options": [
    ...
    },
    {
      ...
      "question": "¿Cuál de las siguientes afirmaciones sobre JSON es correcta?",
      "options": [
    ...
    },
    {
      ...
      "question": "¿Cuál de los siguientes nombres de etiqueta o atributo XML es inválido según las reglas de nombres de XML?",
      "options": [
        "<nombreValido>",
        "<dato-2023>",
        "<XML_data>",
    ...
    },
    {
      ...
      "question": "Al abrir un documento XML directamente en un navegador web sin asociarle ninguna tecnología adicional (como CSS o XSLT), ¿cómo se presentará la información al usuario?",
      "options": [
    ...
    },
    {
      ...
      "question": "En la estructura jerárquica de un documento XML, si la etiqueta <carreras> es un hijo de <facultad>, y dentro de <carreras> se encuentra la etiqueta <carrera>, ¿qué relación tiene <carrera> con <facultad>?",
      "options": [
      ...
      "correct": 2,
      "explanation": "<carrera> es un descendiente de <facultad>, al estar contenida en un elemento que a su vez es hijo de <facultad> es la respuesta correcta para esta pregunta del temario oficial.",
      "unit": null
    },
    {
      "concept_id": "lm_tema_3_q6",
      "question": "Si en un esquema XML (XSD) se desea restringir el valor de un elemento de tipo xs:string a un conjunto específico y limitado de valores predefinidos (por ejemplo, \"conectado\", \"ocupado\" o \"ausente\"), ¿qué faceta se debe utilizar dentro de xs:restriction?",
      "options": [
    ...
    },
    {
      ...
      "question": "¿Cuál de los siguientes es un inconveniente principal de las Definiciones de Tipo de Documento (DTD) en comparación con los Esquemas XML (XSD)?",
      "options": [
    ...
    },
    {
      ...
      "question": "En XML, cuando se declara un espacio de nombres por defecto (sin prefijo, por ejemplo xmlns=\"URI\"), ¿a qué elementos del documento afecta su ámbito de aplicación?",
      "options": [
    ...
    },
    {
      ...
      "question": "¿Qué elemento del lenguaje XSD (XML Schema Definition) se utiliza para construir tipos complejos especificando que sus componentes deben aparecer en un orden determinado y fijo?",
      "options": [
  ...
  "lm_tema_4": [
    {
      ...
      "question": "¿Qué elemento se utiliza en un Schema XML (XSD) para definir tipos complejos que contienen otros elementos o atributos, y que permite especificar la secuencia u orden de aparición de sus hijos?",
      "options": [
        "xs:all",
        "xs:choice",
        "xs:sequence",
    ...
    },
    {
      ...
      "question": "Los DTD (Document Type Definition) tienen varios problemas que los Schemas XML resuelven. ¿Cuál de los siguientes es un problema recurrente de los DTD?",
      "options": [
    ...
    },
    {
      ...
      "question": "¿Cuál de los siguientes atributos del elemento raíz xs:schema en un XSD se utiliza para indicar si los elementos deben llevar el espacio de nombres delante (qualified o unqualified)?",
      "options": [
        "TargetNamespace",
        "xmlns:alias",
        "elementFormDefault",
    ...
    },
    {
      ...
      "question": "¿Cuál de las siguientes afirmaciones describe mejor el objetivo principal de un Schema XML en comparación con un DTD?",
      "options": [
    ...
    },
    {
      ...
      "question": "Para definir un tipo de dato simple personalizado en un Schema XML, ¿qué estructura principal se utiliza?",
      "options": [
        "xs:complexType",
        "xs:simpleType",
        "xs:element",
    ...
    },
    {
      ...
      "question": "En XML Schema, ¿cuál de las siguientes facetas o restricciones se utiliza para especificar un rango de caracteres admitidos o una expresión regular para el valor de un elemento o atributo?",
      "options": [
        "xs:Enumeration",
        "xs:MaxLength",
        "xs:Pattern",
    ...
    },
    {
      ...
      "question": "¿Cómo se asocia un documento XML con un Schema XML (XSD) cuando se utilizan explícitamente los nombres de los espacios de nombres en las etiquetas del documento XML?",
      "options": [
    ...
    },
    {
      ...
      "question": "En un documento XSD, si se desea especificar que un elemento puede aparecer un número ilimitado de veces, ¿qué valor se debe asignar al atributo maxOccurs?",
      "options": [
        "0",
        "1",
        "unbounded",
    ...
    },
    {
      ...
      "question": "Si en un XSD se desea imponer una restricción a un atributo para que su valor sea obligatorio (required), ¿qué atributo del elemento xs:attribute se debe usar y con qué valor?",
      "options": [
        "default",
    ...
    },
    {
      ...
      "question": "Según los principios de validación de documentos XML, ¿cuál de las siguientes afirmaciones es correcta?",
      "options": [
  ...
  "lm_tema_5": [
    ...
    },
    {
      ...
      "question": "¿Cuál de los siguientes componentes de XSL está orientado a la definición de formatos de presentación para distintos medios (como PDF) y no a la transformación directa a HTML/XML?",
      "options": [
        "XPath",
        "XSLT",
        "XSL-FO",
    ...
    },
    {
      ...
      "question": "Para mostrar el valor de un atributo llamado \"identificador\" del elemento actual en XSLT, ¿qué expresión XPath se usa con xsl:value-of?",
      "options": [
        "../identificador",
        "identificador",
        "@identificador",
    ...
    },
    {
      ...
      "question": "Si se desea iterar sobre todos los elementos producto de un XML y aplicar una transformación a cada uno, ¿qué instrucción XSLT se debe usar?",
      "options": [
        "xsl:value-of",
        "xsl:for-each",
        "xsl:if",
  ...
  "lm_tema_6": [
    {
      ...
      "question": "¿Qué característica distingue a las bases de datos XML nativas y las hace especialmente eficientes para trabajar con documentos XML grandes y complejos?",
      "options": [
    ...
    },
    {
      ...
      "question": "¿Cuál de los siguientes es un requisito indispensable para la instalación y ejecución de la base de datos XML nativa eXist-db?",
      "options": [
        "Un entorno de desarrollo como Apache o Nginx preinstalado",
        "Tener Java 1.7 o una versión posterior instalada en el sistema operativo",
        "Un mínimo de 2048 MB de memoria RAM dedicados exclusivamente al servicio",
        "Mediante una subconsulta correlacionada con EXISTS"
      ],
      "correct": 1,
    ...
    },
    {
      ...
      "question": "¿Cuál es una de las principales desventajas de las bases de datos \"XML enabled\" en comparación con las bases de datos XML nativas?",
      "options": [
    ...
    },
    {
      ...
      "question": "Si en un documento XML queremos seleccionar todos los nodos elemento hijos directos de cada elemento <coche> que esté bajo <concesionario>, sin especificar los nombres de esos hijos, ¿qué comodín o expresión XPath se usaría correctamente?",
      "options": [
        "//coche/node()",
        "/concesionario/coche/*",
        "concesionario/coche//@*",
      ...
      "correct": 2,
      "explanation": "concesionario/coche//@* es la respuesta correcta para esta pregunta del temario oficial.",
      "unit": null
    },
    {
      "concept_id": "lm_tema_6_q5",
      "question": "XQuery es un lenguaje de consulta y manipulación de XML que incorpora XPath.<br/>¿Cuál de las siguientes afirmaciones sobre XQuery es correcta?",
      "options": [
        "No permite el acceso a múltiples documentos XML en una misma consulta, a diferencia de SQL",
        "Ofrece capacidades de transformación, permitiendo no solo recuperar datos sino también devolver un resultado con una nueva estructura",
        "Carece de funciones integradas para trabajar con tipos de datos como cadenas, números o fechas",
        "Mediante una subconsulta correlacionada con EXISTS"
      ],
      "correct": 1,
    ...
    },
    {
      ...
      "question": "Si tenemos el siguiente fragmento XML: <concesionario><coche id=\"1\"><marca>Volkswagen</marca></coche><coche id=\"2\"><marca>Audi</marca></coche></concesionario>, ¿qué expresión XPath devolvería el elemento <coche> con el atributo id igual a \"2\"?",
      "options": [
      ...
      "correct": 2,
      "explanation": "/concesionario/coche[@id=\"2\"] es la respuesta correcta para esta pregunta del temario oficial.",
      "unit": null
    },
    {
      "concept_id": "lm_tema_6_q7",
      "question": "La herramienta IMPORTXML de Google Sheets, ¿para qué se utiliza principalmente?",
      "options": [
    ...
    },
    {
      ...
      "question": "En XPath, si se necesita seleccionar la marca y el modelo de todos los coches en un documento XML dentro de una misma expresión de ruta, ¿qué operador se debe utilizar para unir ambas rutas?",
      "options": [
    ...
    },
    {
      ...
      "question": "¿Cuál es la principal diferencia funcional entre XPath y XQuery según los materiales de la unidad?",
      "options": [
  ...
  "lm_tema_7": [
    {
      ...
      "question": "En la estructura de un feed RSS 2.0, ¿cuáles son los tres elementos secundarios obligatorios que debe contener el elemento <channel>?",
      "options": [
        "<item>, <author>, <pubDate>",
    ...
    },
    {
      ...
      "question": "¿Cuál fue una de las principales motivaciones para el desarrollo del estándar Atom como alternativa a RSS, según el contenido de la unidad?",
      "options": [
    ...
    },
    {
      ...
      "question": "Para evitar problemas con caracteres acentuados o la letra \"ñ\" al sindicar un canal, ¿qué práctica se recomienda en la codificación?",
      "options": [
        "Convertir todos los caracteres especiales a sus equivalentes en el alfabeto inglés",
        "Utilizar la codificación UTF-8 y las entidades XML correspondientes (por ejemplo, á en lugar de á)",
        "Limitar la sindicación de contenidos a plataformas que no admitan dichos caracteres",
        "Ninguna de las anteriores opciones es completamente correcta en este contexto"
      ],
      "correct": 1,
      "explanation": "Utilizar la codificación UTF-8 y las entidades XML correspondientes (por ejemplo, á en lugar de á) es la respuesta correcta para esta pregunta del temario oficial.",
      "unit": null
    },
    {
      "concept_id": "lm_tema_7_q3",
      "question": "¿Cuál es el propósito principal de la sindicación de contenidos, también conocida como redifusión web?",
      "options": [
    ...
    },
    {
      ...
      "question": "Si un Sistema de Gestión de Contenidos (CMS) permite generar tanto archivos HTML como canales RSS a partir del mismo contenido, ¿qué proceso técnico subyace a la creación de los canales RSS en este contexto?",
      "options": [
    ...
    },
    {
      ...
      "question": "¿Cuáles son los dos estándares o formatos más utilizados para la sindicación de contenidos, ambos basados en tecnología XML?",
      "options": [
        "HTML y CSS",
        "JSON y YAML",
        "RSS y Atom.",
    ...
    },
    {
      ...
      "question": "¿Cuál es una diferencia clave entre los \"agregadores web\" y los \"agregadores de escritorio\" mencionados en la unidad?",
      "options": [
      ...
      "correct": 1,
      "explanation": "Los agregadores web están alojados en sitios específicos y se acceden a través de un navegador (ideales para múltiples dispositivos), mientras que los de escritorio son aplicaciones que se instalan localmente en un dispositivo (ideales para un uso fijo) es la respuesta correcta para esta pregunta del temario oficial.",
      "unit": null
    },
    {
  ...
  "lm_tema_8": [
    {
      ...
      "question": "¿Cuál es el objetivo principal que persigue el uso de un software ERP unificado en una empresa en contraste con el uso de aplicaciones distintas por departamento?",
      "options": [
    ...
    },
    {
      ...
      "question": "Antes de proceder a la instalación de cualquier paquete de gestión empresarial (ERP), ¿cuál es un requisito previo fundamental, independientemente del software seleccionado?",
      "options": [
        "Contratar un servicio de hosting en la nube específico para el ERP",
        "Crear previamente la base de datos en el sistema, ya que todo ERP se apoya en una base de datos centralizada",
        "Instalar un entorno de desarrollo integrado (IDE) para la personalización futura",
        "Ninguna de las anteriores opciones es completamente correcta en este contexto"
      ],
      "correct": 1,
    ...
    },
    {
      ...
      "question": "La proliferación de dispositivos portátiles y la presencia de empleados móviles ha impulsado una necesidad específica en la gestión de flujos de información empresarial. ¿Cuál es esta necesidad?",
      "options": [
        "Limitar el acceso a la información únicamente desde las oficinas centrales para garantizar la seguridad",
        "Encontrar soluciones que integren a estos empleados en los flujos de información de la empresa en tiempo real",
        "Reducir la cantidad de información disponible para los empleados móviles para evitar la saturación",
        "Ninguna de las anteriores opciones es completamente correcta en este contexto"
      ],
      "correct": 1,
    ...
    },
    {
      ...
      "question": "Más allá de ser una simple lista de contactos, ¿qué función adicional y crucial cumple una plataforma CRM al recopilar e integrar datos?",
      "options": [
        "Generar automáticamente informes financieros detallados para auditorías externas",
        "Mantener a los equipos actualizados con información personalizada sobre los clientes, su historial y sus preferencias de compra",
        "Reemplazar completamente las funciones de un sistema de gestión de almacén (WMS)",
        "Ninguna de las anteriores opciones es completamente correcta en este contexto"
      ],
      "correct": 1,
    ...
    },
    {
      ...
      "question": "Si bien la exportación de información desde un ERP a suites ofimáticas ofrece muchas ventajas, ¿cuál es el riesgo crítico que se menciona explícitamente y requiere medidas de seguridad?",
      "options": [
        "La incompatibilidad de formatos entre el ERP y el software ofimático",
        "La ralentización del sistema ERP debido a la carga de datos exportados",
        "El riesgo de filtrar información confidencial de la empresa hacia el exterior sin el control adecuado",
    ...
    },
    {
      ...
      "question": "¿De dónde pueden provenir los módulos complementarios que se integran en una aplicación ERP base?",
      "options": [
        "Únicamente del fabricante del software base para asegurar la compatibilidad",
        "Pueden ser provistos por el fabricante, desarrollados por terceros o incluso ser programas personalizados solicitados por la empresa",
        "Solamente de repositorios open source, ya que los módulos propietarios limitan la flexibilidad",
        "Ninguna de las anteriores opciones es completamente correcta en este contexto"
      ],
      "correct": 1,
    ...
    },
    {
      ...
      "question": "¿Cuál es una de las capacidades de configuración que ofrecen los formularios en un sistema ERP al ser completados?",
      "options": [
        "Generar automáticamente código de programación para nuevas funcionalidades",
        "Activar acciones automatizadas como notificar a personas designadas o integrar los datos con otro software como SAP o Salesforce",
        "Modificar la estructura de la base de datos central del ERP",
        "Ninguna de las anteriores opciones es completamente correcta en este contexto"
      ],
      "correct": 1,
    ...
    },
    {
      ...
      "question": "En un sistema ERP, ¿qué ocurre cuando a un usuario se le asignan múltiples roles y uno de ellos impone restricciones más estrictas que los demás?",
      "options": [
    ...
    },
    {
      ...
      "question": "¿Cuál de las siguientes acciones representa un ejemplo de \"adaptación\" de un sistema ERP, según la definición de la unidad?",
      "options": [
        "Añadir un campo personalizado en las órdenes de envío para indicar el tipo de embalaje, que no venía por defecto en el sistema",
        "Definir que las facturas electrónicas se emitan automáticamente en formato XML-UBL",
        "Configurar las reglas de seguridad y las restricciones de acceso para distintos usuarios",
        "Ninguna de las anteriores opciones es completamente correcta en este contexto"
      ],
      "correct": 0,
    ...
    },
    {
      ...
      "question": "¿Qué ventaja clave ofrecen los ERP en la nube en términos de seguridad?",
      "options": [
        "La seguridad se relaja pasado un tiempo, ya que es más difícil de mantener actualizada",
        "Son inherentemente invulnerables a cualquier tipo de ataque informático",
        "Implementan las últimas novedades en seguridad de forma inmediata y aplican la seguridad por capas, reduciendo vulnerabilidades",
  ...
  "emp_tema_1": [
    {
      "concept_id": "emp_tema_1_q0",
      "question": "¿Entre qué tipo de riesgos laborales se incluye el mobbing?",
      "options": [
        "Biológicos",
        "Ergonómicos",
        "Físicos",
  ...
  "emp_tema_2": [
    {
      ...
      "question": "¿En cuál de los siguientes procedimientos de resolución de conflictos es un tercero el que establece la solución vinculante?",
      "options": [
        "Conciliación",
        "Negociación",
        "Mediación",
  ...
  "emp_tema_4": [
    {
      ...
      "question": "¿Cómo se denomina el Portal Europeo de Movilidad Profesional?",
      "options": [
        "Europass",
        "Erasmus",
  ...
  "ipe_pdf_custom": [
    {
      ...
      "question": "En una empresa forestal, el encargado detecta que varios trabajadores adoptan posturas forzadas durante largas jornadas al utilizar herramientas manuales. Este tipo de situación puede derivar en:",
      "options": [
        "Riesgos químicos por exposición a sustancias",
        "Riesgos ergonómicos relacionados con la postura",
        "Riesgos biológicos por contacto con organismos",
    ...
    },
    {
      ...
      "question": "Durante una jornada laboral, un trabajador empieza a mostrar síntomas de agotamiento físico y dificultad para concentrarse tras varias horas de trabajo continuo. Este fenómeno se conoce como:",
      "options": [
        "Estrés laboral exclusivamente",
        "Fatiga laboral, que puede ser física y mental",
    ...
    },
    {
      ...
      "question": "Una empresa decide implantar pausas periódicas y rotación de tareas para reducir la monotonía y el cansancio. Estas medidas actúan principalmente sobre:",
      "options": [
        "El origen del riesgo físico",
    ...
    },
    {
      ...
      "question": "En una situación de emergencia, un trabajador decide evacuar el lugar sin seguir las indicaciones establecidas en el plan de autoprotección. Esta conducta:",
      "options": [
        "Es adecuada si no hay daños",
        "Mejora la rapidez de evacuación",
        "Puede poner en peligro a otras personas",
        "Es irrelevante en emergencias"
      ],
      "correct": 2,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
      "unit": null
    },
    {
      ...
      "question": "En relación con la búsqueda de empleo, una persona que utiliza redes profesionales para establecer contactos y conocer oportunidades laborales está desarrollando:",
      "options": [
        "Formación continua",
        "Networking",
        "Autoempleo",
    ...
    },
    {
      ...
      "question": "Un trabajador recibe comentarios constructivos sobre su desempeño por parte de su superior con el objetivo de mejorar su rendimiento. Este proceso se denomina:",
      "options": [
    ...
    },
    {
      ...
      "question": "En una empresa, los trabajadores colaboran activamente, comparten información y persiguen objetivos comunes. Esta situación refleja:",
      "options": [
        "Competencia interna",
        "Trabajo en equipo",
    ...
    },
    {
      ...
      "question": "Una empresa introduce nuevas tecnologías para mejorar sus procesos productivos y adaptarse al mercado. Esta acción está relacionada con:",
      "options": [
        "Reducción de costes exclusivamente",
    ...
    },
    {
      ...
      "question": "El organigrama de una empresa permite conocer:",
      "options": [
        "Los beneficios económicos",
        "La estructura jerárquica y funcional",
    ...
    },
    {
      ...
      "question": "Un emprendedor analiza si su idea de negocio será rentable antes de ponerla en marcha. Para ello utiliza:",
      "options": [
    ...
    },
    {
      ...
      "question": "En una empresa, los costes que no varían aunque aumente o disminuya la producción se denominan:",
      "options": [
        "Costes variables",
        "Costes fijos",
        "Costes directos",
    ...
    },
    {
      ...
      "question": "El punto muerto o umbral de rentabilidad es aquel nivel de producción en el que:",
      "options": [
        "Se obtienen máximos beneficios",
        "Los ingresos igualan a los costes",
    ...
    },
    {
      ...
      "question": "Un trabajador que es capaz de adaptarse a cambios, superar dificultades y mantener una actitud positiva está demostrando:",
      "options": [
        "Productividad",
        "Resiliencia",
        "Competitividad",
    ...
    },
    {
      ...
      "question": "En el ámbito laboral, la inteligencia emocional permite:",
      "options": [
        "Ignorar las emociones propias",
        "Gestionar adecuadamente emociones y relaciones",
    ...
    },
    {
      ...
      "question": "Un conflicto entre compañeros puede resolverse de manera positiva si:",
      "options": [
        "Se ignora el problema",
        "Se utiliza el diálogo y la negociación",
        "Se impone una decisión",
    ...
    },
    {
      ...
      "question": "La formación continua es clave en el mercado laboral actual porque:",
      "options": [
        "Evita cambios en el empleo",
        "Permite adaptarse a nuevas demandas",
    ...
    },
    {
      ...
      "question": "El teletrabajo se caracteriza por:",
      "options": [
        "Realizar el trabajo exclusivamente en la empresa",
        "Desarrollar la actividad a distancia mediante tecnologías",
        "No tener horario laboral",
    ...
    },
    {
      ...
      "question": "Una empresa que adopta medidas para reducir su impacto ambiental está aplicando:",
      "options": [
        "Productividad",
    ...
    },
    {
      ...
      "question": "La toma de decisiones en el ámbito profesional implica:",
      "options": [
    ...
    },
    {
      ...
      "question": "El clima laboral de una empresa influye directamente en:",
      "options": [
        "Solo en la dirección",
        "El bienestar y rendimiento de los trabajadores",
        "Únicamente en los beneficios",
        "La maquinaria"
      ],
      "correct": 1,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
    ...
    },
    {
      ...
      "question": "Un desarrollador junior desea mejorar su empleabilidad en el sector IT creando un entorno personal de aprendizaje (PLE). ¿Cuál de las siguientes acciones refleja mejor un uso eficaz de este entorno?",
      "options": [
        "Memorizar documentación técnica sin aplicarla",
        "Combinar cursos online, comunidades técnicas y herramientas de gestión del conocimiento",
        "Limitarse a la formación reglada del ciclo",
        "Centrarse únicamente en redes sociales personales"
      ],
      "correct": 1,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
      "unit": null
    },
    {
      ...
      "question": "En el sector tecnológico, la identificación de necesidades de aprendizaje es clave debido a:",
      "options": [
        "La estabilidad de los conocimientos técnicos",
        "La rápida obsolescencia de las competencias digitales",
        "La baja competencia profesional",
    ...
    },
    {
      ...
      "question": "¿Cuál de las siguientes herramientas sería más adecuada para organizar documentación técnica y apuntes en proyectos de programación?",
      "options": [
        "Instagram",
        "Microsoft OneNote",
        "TikTok",
    ...
    },
    {
      ...
      "question": "Un profesional IT utiliza GitHub, foros técnicos y LinkedIn para compartir conocimiento. Esto forma parte de:",
      "options": [
        "Currículum oculto",
    ...
    },
    {
      ...
      "question": "En el desarrollo de software, un Plan de Desarrollo Personal (PDP) permite:",
      "options": [
        "Eliminar la necesidad de formación continua",
        "Establecer objetivos profesionales y acciones concretas para lograrlos",
        "Sustituir la experiencia laboral",
        "Garantizar automáticamente un empleo"
      ],
      "correct": 1,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
      "unit": null
    },
    {
      ...
      "question": "¿Cuál de las siguientes opciones refleja mejor un objetivo SMART en el ámbito IT?",
      "options": [
        "Mejorar en programación",
        "Aprender cosas nuevas",
        "Completar un curso de Python en 3 meses con certificación",
    ...
    },
    {
      ...
      "question": "La identidad digital de un programador influye en su empleabilidad porque:",
      "options": [
        "Solo importa el currículum físico",
        "Los reclutadores analizan la presencia online y proyectos visibles",
        "No tiene impacto en el sector IT",
        "Es irrelevante frente a la experiencia"
      ],
      "correct": 1,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
      "unit": null
    },
    {
      ...
      "question": "¿Cuál de los siguientes es un riesgo asociado a una mala gestión de la identidad digital en el sector tecnológico?",
      "options": [
        "Mejora del networking",
        "Incremento de oportunidades laborales",
        "Pérdida de reputación profesional",
        "Aumento de visibilidad positiva"
      ],
      "correct": 2,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
      "unit": null
    },
    {
      ...
      "question": "El phishing en entornos IT consiste en:",
      "options": [
        "Optimizar sistemas",
        "Robar información mediante engaño",
    ...
    },
    {
      ...
      "question": "¿Cuál de las siguientes medidas es más eficaz para proteger cuentas profesionales en entornos digitales?",
      "options": [
    ...
    },
    {
      ...
      "question": "El análisis del potencial profesional en el sector IT incluye:",
      "options": [
        "Solo habilidades técnicas",
        "Solo experiencia laboral",
        "Habilidades técnicas y blandas",
        "Solo formación académica"
      ],
      "correct": 2,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
      "unit": null
    },
    {
      ...
      "question": "Un análisis DAFO aplicado a un desarrollador identifica como oportunidad:",
      "options": [
    ...
    },
    {
      ...
      "question": "¿Cuál de las siguientes opciones representa una debilidad en un perfil IT?",
      "options": [
    ...
    },
    {
      ...
      "question": "El autoconocimiento en el ámbito profesional permite:",
      "options": [
        "Evitar decisiones laborales",
        "Identificar intereses y orientar la carrera profesional",
        "Sustituir la formación",
        "Eliminar errores"
      ],
      "correct": 1,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
    ...
    },
    {
      ...
      "question": "La inteligencia emocional en equipos de desarrollo software favorece:",
      "options": [
    ...
    },
    {
      ...
      "question": "Una mentalidad de crecimiento en el sector IT implica:",
      "options": [
        "Evitar retos",
        "Creer que las habilidades son fijas",
        "Mejorar mediante esfuerzo y aprendizaje continuo",
        "No aceptar errores"
      ],
      "correct": 2,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
    ...
    },
    {
      ...
      "question": "En relación con el sector productivo IT, una característica clave es:",
      "options": [
    ...
    },
    {
      ...
      "question": "El equilibrio entre competencias personales y demandas del mercado implica:",
      "options": [
        "Ignorar el mercado laboral",
        "Adaptar habilidades a necesidades del sector",
        "Elegir solo por vocación",
        "Evitar formación"
      ],
      "correct": 1,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
    ...
    },
    {
      ...
      "question": "Un itinerario formativo tras un ciclo de informática puede incluir:",
      "options": [
        "Solo empleo",
        "Solo universidad",
        "Formación, especialización o empleo",
        "Ninguna opción"
      ],
      "correct": 2,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
    ...
    },
    {
      ...
      "question": "La Formación Profesional Dual en el sector IT se caracteriza por:",
      "options": [
        "Formación teórica exclusivamente",
        "Formación combinada con práctica en empresa",
        "Eliminación de prácticas",
        "Formación online únicamente"
      ],
      "correct": 1,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
      "unit": null
    },
    {
      ...
      "question": "Un curso de especialización en ciberseguridad permite:",
      "options": [
        "Reducir empleabilidad",
        "Acceder a perfiles altamente demandados",
        "Evitar formación continua",
    ...
    },
    {
      ...
      "question": "En un plan de acción profesional en IT, los recursos incluyen:",
      "options": [
        "Solo dinero",
        "Formación, herramientas y contactos",
        "Solo tiempo",
        "Solo experiencia"
      ],
      "correct": 1,
    ...
    },
    {
      ...
      "question": "Desde la perspectiva de PRL en oficinas IT, un riesgo común es:",
      "options": [
        "Caídas en altura",
    ...
    },
    {
      ...
      "question": "Una función del nivel básico en PRL en el sector IT es:",
      "options": [
        "Diseñar software",
    ...
    },
    {
      ...
      "question": "La adopción de medidas preventivas en entornos informáticos tiene como objetivo:",
      "options": [
        "Reducir productividad",
        "Mejorar bienestar y evitar riesgos laborales",
        "Aumentar errores"
      ],
      "correct": 1,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
    ...
    },
    {
      ...
      "question": "Un desarrollador backend decide mejorar su aprendizaje autónomo creando un entorno personal de aprendizaje (PLE). Para ello combina cursos online, repositorios de código, blogs técnicos y herramientas de organización. Sin embargo, tras varios meses no percibe mejora significativa en sus competencias. ¿Cuál sería la causa más probable de esta situación?",
      "options": [
        "Uso de demasiadas fuentes de información",
        "Falta de planificación, objetivos y evaluación del aprendizaje",
        "Exceso de formación reglada",
        "Uso exclusivo de herramientas digitales"
      ],
      "correct": 1,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
      "unit": null
    },
    {
      ...
      "question": "En el contexto del sector IT, la autoevaluación de competencias resulta clave para la empleabilidad. ¿Qué aspecto diferencia principalmente una autoevaluación eficaz de una ineficaz?",
      "options": [
        "Se basa únicamente en percepciones subjetivas",
        "Incluye contraste con requerimientos del mercado y evidencia objetiva",
        "Evita analizar debilidades",
    ...
    },
    {
      ...
      "question": "Un profesional de desarrollo web detecta que el mercado demanda conocimientos en frameworks modernos que él no domina. Según el enfoque del Plan de Desarrollo Personal (PDP), ¿qué acción sería más adecuada?",
      "options": [
        "Ignorar la tendencia",
        "Establecer objetivos formativos concretos y planificar su adquisición",
        "Cambiar de sector profesional",
        "Centrarse solo en su experiencia previa"
      ],
      "correct": 1,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
      "unit": null
    },
    {
      ...
      "question": "En relación con la identidad digital en el sector tecnológico, un candidato publica contenido técnico en redes profesionales, pero también comentarios polémicos en redes personales. ¿Qué implicación tiene esto en su empleabilidad?",
      "options": [
        "No tiene impacto si son redes distintas",
        "Puede afectar negativamente a su reputación profesional",
        "Solo influye la experiencia laboral",
        "Es irrelevante para reclutadores"
      ],
      "correct": 1,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
      "unit": null
    },
    {
      ...
      "question": "Un analista de datos comparte habitualmente código y proyectos en plataformas públicas. ¿Qué ventaja competitiva le proporciona esta práctica en procesos de selección?",
      "options": [
        "Reduce la necesidad de entrevistas",
        "Permite evidenciar competencias reales y marca personal",
        "Sustituye el currículum",
        "Evita la formación continua"
      ],
      "correct": 1,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
      "unit": null
    },
    {
      ...
      "question": "En el análisis DAFO de un perfil IT, ¿cuál de las siguientes situaciones se consideraría una amenaza externa?",
      "options": [
        "Falta de experiencia en un lenguaje",
        "Baja autoestima profesional",
        "Alta competencia en el mercado tecnológico",
    ...
    },
    {
      ...
      "question": "Un técnico informático presenta alta capacidad analítica pero dificultades en comunicación. ¿Cómo se clasificaría esta situación en términos de potencial profesional?",
      "options": [
        "Solo fortaleza",
        "Solo oportunidad",
        "Combinación de fortaleza técnica y debilidad transversal",
        "Amenaza externa"
      ],
      "correct": 2,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
    ...
    },
    {
      ...
      "question": "La adaptación continua en el sector IT implica que los profesionales deben:",
      "options": [
        "Mantener conocimientos estables",
        "Actualizar competencias de forma permanente",
        "Evitar especialización",
        "Depender exclusivamente de la empresa"
      ],
      "correct": 1,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
      "unit": null
    },
    {
      ...
      "question": "En el diseño de un itinerario formativo en informática, ¿qué factor es más relevante para garantizar la empleabilidad futura?",
      "options": [
        "Elegir el camino más corto",
        "Adaptarse a las tendencias tecnológicas del mercado",
        "Evitar cambios formativos",
        "Seguir únicamente preferencias personales"
      ],
      "correct": 1,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
      "unit": null
    },
    {
      ...
      "question": "Un estudiante de DAM duda entre trabajar o seguir formándose. Desde la perspectiva del sistema de FP actual, ¿qué opción es más adecuada?",
      "options": [
        "Solo trabajar",
        "Solo estudiar",
        "Combinar formación continua y experiencia profesional",
        "Abandonar formación"
      ],
      "correct": 2,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
    ...
    },
    {
      ...
      "question": "En el sector IT, el uso de herramientas de inteligencia artificial en el autoconocimiento permite:",
      "options": [
        "Sustituir la reflexión personal",
        "Analizar patrones y recomendar desarrollo profesional",
        "Eliminar la formación",
        "Reducir la empleabilidad"
      ],
      "correct": 1,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
      "unit": null
    },
    {
      ...
      "question": "Dentro de un plan de acción profesional, el establecimiento de plazos tiene como finalidad:",
      "options": [
        "Reducir flexibilidad",
        "Controlar el progreso y evitar la procrastinación",
        "Eliminar objetivos",
        "Sustituir la evaluación"
      ],
      "correct": 1,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
      "unit": null
    },
    {
      ...
      "question": "En un entorno de trabajo IT, el riesgo ergonómico más habitual se relaciona con:",
      "options": [
        "Manipulación de cargas pesadas",
        "Uso prolongado de pantallas y posturas inadecuadas",
        "Riesgos químicos",
        "Exposición a ruido extremo"
      ],
      "correct": 1,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
      "unit": null
    },
    {
      ...
      "question": "Desde el nivel básico de PRL, ¿qué actuación es prioritaria en un entorno de oficina tecnológica?",
      "options": [
        "Programar sistemas de seguridad",
        "Identificar riesgos y proponer medidas preventivas",
        "Diseñar software",
        "Gestionar redes"
      ],
      "correct": 1,
    ...
    },
    {
      ...
      "question": "La prevención de riesgos laborales en el sector IT contribuye a:",
      "options": [
        "Disminuir la productividad",
        "Mejorar la salud, el bienestar y el rendimiento profesional",
        "Aumentar el estrés",
    ...
    },
    {
      ...
      "question": "Clara, desarrolladora junior, se ha inscrito en varios cursos de programación, sigue canales técnicos y guarda artículos en diferentes plataformas. Sin embargo, siente que no progresa porque no logra consolidar conocimientos ni aplicarlos en proyectos reales. ¿Qué medida sería más adecuada para mejorar su aprendizaje autónomo?",
      "options": [
        "Seguir acumulando más cursos y recursos",
        "Organizar un plan estructurado con objetivos y práctica aplicada",
        "Abandonar el aprendizaje online"
      ],
      "correct": 1,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
      "unit": null
    },
    {
      ...
      "question": "Mario utiliza diversas herramientas digitales (notas, repositorios, calendarios) para su aprendizaje en ciberseguridad, pero no revisa su progreso ni ajusta su planificación. ¿Qué elemento clave de su entorno personal de aprendizaje está fallando?",
      "options": [
    ...
    },
    {
      ...
      "question": "Lucía, analista de datos, identifica que tiene gran capacidad técnica pero dificultades para trabajar en equipo. En su análisis DAFO, ¿cómo debería clasificar esta situación?",
      "options": [
        "Fortaleza global",
        "Debilidad interna en competencias transversales",
        "Amenaza externa"
      ],
      "correct": 1,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
    ...
    },
    {
      ...
      "question": "Carlos quiere orientar su carrera en desarrollo de IA, pero no está seguro de sus capacidades. Decide realizar test de competencias, analizar su experiencia previa y reflexionar sobre sus intereses. ¿Qué proceso está aplicando?",
      "options": [
        "Formación reglada",
        "Autoconocimiento profesional",
        "Evaluación externa del mercado"
      ],
      "correct": 1,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
      "unit": null
    },
    {
      ...
      "question": "Una empresa tecnológica busca desarrolladores con conocimientos en cloud y trabajo colaborativo. Ana tiene alta formación técnica pero no experiencia en herramientas colaborativas. ¿Qué debería hacer para mejorar su empleabilidad?",
      "options": [
        "Mantener su perfil actual",
        "Adaptar sus competencias a las demandas del sector",
        "Cambiar de sector"
      ],
      "correct": 1,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
    ...
    },
    {
      ...
      "question": "Pedro finaliza un ciclo de DAM y duda entre trabajar o realizar un curso de especialización en ciberseguridad. Analiza el mercado y detecta alta demanda en este ámbito. ¿Cuál sería la decisión más estratégica?",
      "options": [
        "Elegir sin analizar el mercado",
        "Continuar formándose en un área con alta demanda",
        "Evitar especialización"
      ],
      "correct": 1,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
    ...
    },
    {
      ...
      "question": "Laura establece como objetivo “mejorar en programación”, pero no define plazos ni criterios de evaluación. Tras meses, no percibe avances. ¿Cuál es el problema principal?",
      "options": [
        "Falta de recursos",
        "Objetivo mal definido (no es SMART)",
        "Exceso de formación"
      ],
      "correct": 1,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
    ...
    },
    {
      ...
      "question": "Un técnico IT diseña un plan de acción donde identifica carencias, establece metas, recursos y plazos, pero no revisa resultados. ¿Qué fase está omitiendo?",
      "options": [
    ...
    },
    {
      ...
      "question": "Un programador trabaja más de 8 horas frente al ordenador sin pausas, presentando fatiga visual y dolores musculares. ¿Qué tipo de riesgo laboral está presente?",
      "options": [
        "Riesgo químico",
        "Riesgo ergonómico",
        "Riesgo eléctrico"
    ...
    },
    {
      ...
      "question": "En una empresa tecnológica, un trabajador detecta mala iluminación y posturas inadecuadas en el equipo. Como nivel básico en PRL, ¿qué debería hacer?",
      "options": [
        "Ignorar la situación",
        "Comunicar el riesgo y proponer medidas preventivas",
        "Resolverlo sin informar"
      ],
      "correct": 1,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
      "unit": null
    },
    {
      ...
      "question": "Una empresa tecnológica contrata a un desarrollador mediante contrato indefinido. Tras 10 meses de trabajo, la empresa decide extinguir el contrato alegando “bajo rendimiento”, sin aportar pruebas objetivas ni haber realizado advertencias previas ni evaluación del desempeño. El trabajador impugna el despido. ¿Cómo sería calificada previsiblemente esta extinción?",
      "options": [
        "Despido procedente, por facultad organizativa empresarial",
        "Despido improcedente, por falta de acreditación suficiente de la causa",
        "Despido nulo, por vulneración automática de derechos fundamentales"
      ],
      "correct": 1,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
      "unit": null
    },
    {
      ...
      "question": "Una empresa IT implanta un sistema de control de actividad mediante software que registra pulsaciones de teclado y capturas de pantalla periódicas sin informar previamente a los trabajadores. Uno de ellos impugna la medida. Desde el punto de vista del Derecho Laboral y la protección de derechos fundamentales, ¿cuál es la opción más correcta?",
      "options": [
        "Es válida por el poder de dirección empresarial sin limitaciones",
        "Es válida solo si mejora la productividad",
        "Puede ser ilícita por vulnerar el derecho a la intimidad y falta de información previa"
      ],
      "correct": 2,
      "explanation": "Pregunta oficial extraída del PDF de Empleabilidad.",
      "unit": null
  ...
  "prog_tema_1": [
    ...
    },
    {
      ...
      "correct": 0,
      "explanation": "El algoritmo es la lógica del problema y el programa es su implementación en un lenguaje de programación.",
      "unit": null
    },
    {
    ...
    },
    {
      ...
      "correct": 1,
      "explanation": "La respuesta es 'Los objetos que combinan datos y comportamiento.'.",
      "unit": null
    },
    {
      ...
      "correct": 1,
      "explanation": "Porque el código se compila a bytecode y se ejecuta mediante la Máquina Virtual de Java.",
      "unit": null
    },
    {
      ...
      "correct": 1,
      "explanation": "Diseñar, codificar, depurar y mantener programas que ejecuta un ordenador.",
      "unit": null
    },
    {
      ...
      "correct": 1,
      "explanation": "El dato es un valor aislado y la información es el resultado de procesar datos con un contexto.",
      "unit": null
    }
  ],
  "prog_tema_2": [
    ...
    },
    {
      ...
      "correct": 1,
      "explanation": "Cada objeto tiene su propia copia de los atributos definidos en la clase.",
      "unit": null
    },
    {
    ...
    },
    {
      ...
      "correct": 1,
      "explanation": "Una clase es una plantilla que define los atributos (estado) y métodos (comportamiento) de sus objetos. Un objeto es una instancia concreta creada a partir de esa plantilla con new.",
      "unit": null
    },
    {
      ...
      "correct": 1,
      "explanation": "La respuesta es 'Ambas referencias apuntan al mismo objeto en memoria.'.",
      "unit": null
    },
    {
    ...
    },
    {
      ...
      "correct": 1,
      "explanation": "El polimorfismo permite que el mismo método se comporte diferente según el tipo real del objeto. Requiere sobreescritura (@Override) en las clases hijas. Se activa con enlace dinámico en tiempo de ejecución.",
      "unit": null
    },
    {
      ...
      "correct": 1,
      "explanation": "El archivo debe llamarse igual que la clase pública y tener extensión .java.",
      "unit": null
    }
  ],
  "prog_tema_3": [
    {
      ...
      "correct": 1,
      "explanation": "La respuesta es 'Declarar, inicializar, utilizar.'. \"Inicializar, declarar, utilizar.\" y \"Utilizar, declarar, inicializar.\" son incorrectos porque describen conceptos diferentes.",
      "unit": null
    },
    {
      ...
      "correct": 1,
      "explanation": "La respuesta es 'El final de una sentencia para el compilador.'.",
      "unit": null
    },
    {
    ...
    },
    {
      ...
      "correct": 2,
      "explanation": "La respuesta es 'Los paréntesis.'. \"Los operadores aritméticos de suma y resta.\" y \"Los operadores de asignación.\" son incorrectos porque describen conceptos diferentes.",
      "unit": null
    },
    {
    ...
    },
    {
      ...
      "correct": 2,
      "explanation": "La respuesta es 'Se sale inmediatamente del método completo.'.",
      "unit": null
    },
    {
      ...
      "correct": 2,
      "explanation": "La respuesta es 'nombreUsuario'. \"1contador\" y \"nombre usuario\" son incorrectos porque describen conceptos diferentes.",
      "unit": null
    },
    {
      ...
      "correct": 1,
      "explanation": "La respuesta es 'Paquete (opcional), Clase, Método, Sentencias.'. \"Clase, Paquete, Método, Sentencias.\" y \"Método, Clase, Paquete, Sentencias.\" son incorrectos porque describen conceptos diferentes.",
      "unit": null
    },
    {
  ...
  "prog_tema_4": [
    {
      ...
      "question": "¿Cuál de las siguientes afirmaciones describe correctamente la relación entre una clase y un objeto?",
      "options": [
    ...
    },
    {
      ...
      "question": "Java utiliza paso por referencia para objetos y paso por valor para primitivos",
      "options": [
        ...
        "En el uso profesional de la Programación Orientada a Objetos, ¿cuál es la finalidad principal del encapsulamiento?",
    ...
    },
    {
      ...
      "correct": 1,
      "explanation": "Definir varios métodos con el mismo nombre y distinta firma de parámetros.",
      "unit": null
    },
    {
    ...
    },
    {
      ...
      "correct": 1,
      "explanation": "La respuesta es 'La referencia que apunta al objeto almacenado en el Heap.'. \"El objeto completo con todos sus atributos.\" y \"Una copia independiente del objeto original.\" son incorrectos porque describen conceptos diferentes.",
      "unit": null
    },
    {
  ...
  "prog_tema_5": [
    {
      ...
      "options": [
        ...
        "En relación con los índices de un array, señale la afirmación correcta:"
      ],
      "correct": 1,
      "explanation": "La respuesta es 'Son arrays cuyos elementos son, a su vez, otros arrays.'.",
      "unit": null
    },
    {
      "concept_id": "prog_tema_5_q1",
      "question": "El primer elemento se encuentra en la posición 1",
      "options": [
        ...
        "Desde el punto de vista de la memoria en Java, ¿cuál es la característica fundamental de un array?",
        "Es una estructura primitiva que se almacena íntegramente en el Stack"
      ],
      "correct": 1,
      "explanation": "Es un objeto que se almacena en el Heap y se accede mediante una referencia.",
      "unit": null
    },
    {
      ...
      "correct": 2,
      "explanation": "Está orientado a la lectura secuencial sin acceso a la posición.",
      "unit": null
    },
    {
    ...
    },
    {
      ...
      "correct": 1,
      "explanation": "La respuesta es 'Que el array esté previamente ordenado.'.",
      "unit": null
    },
    {
      ...
      "correct": 1,
      "explanation": "El tamaño se fija en el momento de su creación y no puede cambiar.",
      "unit": null
    },
    {
      ...
      "correct": 1,
      "explanation": "Que una vez creado un texto, no puede modificarse su contenido.",
      "unit": null
    },
    {
      ...
      "options": [
        ...
        "Utilizando un método que evalúa el contenido textual (equals o compareTo).",
        "Mediante una clase abstracta con métodos estáticos"
      ],
      "correct": 2,
      "explanation": "Utilizando un método que evalúa el contenido textual (equals o compareTo).",
      "unit": null
    }
  ],
  "prog_tema_6": [
    {
      ...
      "correct": 0,
      "explanation": "Clase abstracta: puede tener código concreto, atributos, herencia simple. Interfaz: solo métodos abstractos (por defecto), implementación múltiple. Abstracta = identidad (\"es un\"), Interfaz = capacidad (\"puede hacer\").",
      "unit": null
    },
    {
      ...
      "options": [
        ...
        "Es exactamente igual al acceso public",
        "Con un certificado SSL autofirmado"
      ],
      "correct": 1,
      "explanation": "Permite el acceso a cualquier clase del mismo paquete y a cualquier subclase, incluso en paquetes distintos.",
      "unit": null
    },
    {
    ...
    },
    {
      ...
      "question": "Sobre las clases abstractas, ¿cuál es la \"Regla de Hierro\"?",
      "options": [
      ...
      "correct": 1,
      "explanation": "No se pueden crear objetos (instancias) de una clase abstracta.",
      "unit": null
    },
    {
      ...
      "correct": 1,
      "explanation": "La respuesta es 'Declarar el método como final.'.",
      "unit": null
    },
    {
    ...
    },
    {
      ...
      "correct": 0,
      "explanation": "Un método o atributo static pertenece a la CLASE, no a los objetos. Se accede con NombreClase.metodo(). No puede acceder a atributos de instancia ni usar this, porque no está asociado a ningún objeto concreto.",
      "unit": null
    },
    {
  ...
  "prog_tema_7": [
    {
      ...
      "correct": 1,
      "explanation": "throws en la firma del método declara que puede lanzar una excepción checked. El llamador debe manejarla con try-catch o propagarla con throws. throw (sin s) lanza la excepción en una línea concreta.",
      "unit": null
    },
    {
      ...
      "correct": 2,
      "explanation": "Iterator es necesario cuando se necesita eliminar elementos de una colección durante la iteración. Usar list.remove() en un for-each lanza ConcurrentModificationException. it.remove() es seguro.",
      "unit": null
    },
    {
      "concept_id": "prog_tema_7_q2",
      "question": "¿Cuál es el propósito de utilizar Genéricos al declarar una colección como ArrayList<String>?",
      "options": [
      ...
      "correct": 1,
      "explanation": "Aportar seguridad de tipos en tiempo de compilación y evitar la necesidad de realizar castings manuales.",
      "unit": null
    },
    {
      ...
      "correct": 1,
      "explanation": "La respuesta es 'Set'. \"List\" y \"Queue\" son incorrectos porque describen conceptos diferentes.",
      "unit": null
    },
    {
    ...
    },
    {
      ...
      "question": "Sobre la interfaz Map, ¿cuál de las siguientes afirmaciones es correcta?",
      "options": [
      ...
      "correct": 1,
      "explanation": "Map almacena pares clave-valor. No hereda de Collection. HashMap no garantiza orden; TreeMap mantiene orden natural de claves; LinkedHashMap mantiene orden de inserción.",
      "unit": null
    },
    {
      "concept_id": "prog_tema_7_q6",
      "question": "¿Cuál es la principal ventaja del \"try-with-resources\"?",
      "options": [
    ...
    },
    {
      ...
      "correct": 1,
      "explanation": "Los Error son situaciones irrecuperables de la JVM, mientras que las Exception son condiciones que una aplicación deberí...",
      "unit": null
    },
    {
    ...
    },
    {
      ...
      "correct": 2,
      "explanation": "Siempre, independientemente de si se lanzó una excepción o si fue capturada.",
      "unit": null
    }
  ],
  "prog_tema_8": [
    {
      ...
      "correct": 1,
      "explanation": "transient marca un atributo para que sea ignorado durante la serialización. Útil para datos sensibles (contraseñas) o datos que no tienen sentido fuera del contexto de ejecución (conexiones, hilos).",
      "unit": null
    },
    {
    ...
    },
    {
      ...
      "correct": 2,
      "explanation": "nextLine() lee toda la línea incluyendo espacios. next() lee solo hasta el primer espacio. nextInt() lee un entero. Para leer frases completas, siempre usar nextLine().",
      "unit": null
    },
    {
      ...
      "correct": 2,
      "explanation": "La respuesta es 'FileReader'. \"FileInputStream\" y \"FileWriter\" son incorrectos porque describen conceptos diferentes.",
      "unit": null
    },
    {
      ...
      "correct": 0,
      "explanation": "El proceso de convertir un objeto en una secuencia de bytes para poder almacenarlo en un fichero o enviarlo por red.",
      "unit": null
    },
    {
      ...
      "correct": 1,
      "explanation": "Se utiliza para mensajes de diagnóstico y errores, y por defecto suele mostrarse en color rojo en la consola.",
      "unit": null
    },
    {
      ...
      "correct": 0,
      "explanation": "Actuar como una memoria intermedia para reducir el número de accesos físicos al disco o red, mejorando el rendimiento.",
      "unit": null
    },
    {
      ...
      "correct": 1,
      "explanation": "Es un canal unidireccional que transporta información de forma secuencial desde un origen a un destino.",
      "unit": null
    },
    {
      ...
      "correct": 1,
      "explanation": "Serializable es una interfaz marcadora (sin métodos) que indica que los objetos de esa clase pueden convertirse en bytes para almacenarse o enviarse por red. serialVersionUID controla la compatibilidad de versiones.",
      "unit": null
    }
  ],
  "prog_tema_9": [
    {
      ...
      "correct": 0,
      "explanation": "JDBC (Java Database Connectivity) es la API estándar de Java para conectarse a bases de datos. El Driver traduce las llamadas JDBC al protocolo específico de cada SGBD (MySQL, Oracle, etc.).",
      "unit": null
    },
    {
    ...
    },
    {
      ...
      "correct": 1,
      "explanation": "ResultSet actúa como un cursor que inicialmente apunta ANTES de la primera fila. next() avanza al siguiente registro y devuelve false cuando no hay más. getString(), getInt() etc. leen los valores.",
      "unit": null
    },
    {
  ...
  "prog_tema_10": [
    {
      ...
      "correct": 1,
      "explanation": "El OID (Object Identifier) es un identificador único generado automáticamente por el sistema para cada objeto en una BDOO. Es independiente del valor de los atributos, a diferencia de las claves primarias relacionales.",
      "unit": null
    },
    {
    ...
    },
    {
      ...
      "correct": 0,
      "explanation": "Las operaciones realizadas sobre un objeto padre se propagan automáticamente a sus objetos hijos relacionados.",
      "unit": null
    },
    {
      ...
      "correct": 1,
      "explanation": "La \"Desadaptación de Impedancia\" (Impedance Mismatch) es el problema de traducir objetos Java a tablas relacionales y viceversa. Las BDOO eliminan este problema almacenando objetos directamente.",
      "unit": null
    },
    {
      ...
      "correct": 1,
      "explanation": "QBE (Query By Example) crea un objeto \"prototipo\" con los valores que se buscan. El sistema devuelve todos los objetos que coincidan con los atributos no nulos del prototipo. Es más intuitivo que OQL.",
      "unit": null
    },
    {
    ...
    },
    {
      ...
      "correct": 1,
      "explanation": "Utilizando la \"notación de punto\" (ej. p.ciudad.nombre) para seguir los grafos de objetos.",
      "unit": null
    },
    {
      ...
      "correct": 1,
      "explanation": "Activation Depth controla cuántos niveles del grafo de objetos se cargan en memoria al recuperar un objeto. Un valor bajo mejora el rendimiento; un valor alto carga más objetos relacionados automáticamente.",
      "unit": null
    },
    {
      ...
      "correct": 1,
      "explanation": "ODL (Object Definition Language) es el lenguaje del estándar ODMG para definir la estructura de una BDOO. OQL (Object Query Language) es para consultas. SQL-92 es para bases de datos relacionales.",
      "unit": null
    },
    {
